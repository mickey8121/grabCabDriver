    ...
    return (
        <View style={styles.containerView}>
            <Header 
                ...
                rightComponent={{icon:'ios-navigate', type:'ionicon', color:colors.WHITE, size: 30, component: TouchableWithoutFeedback,onPress: ()=>{this.handleGetDirections(this.state.rideDetails)}}}
